...
const DRAFT_KEY = 'add_recipe_draft';
...
export default function AddRecipeScreen() {
  ...
  function handleSave() {
    ...
    try {
      insertRecipe(name.trim(), ingredients.trim(), instructions.trim(), finalImage);
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
      <Field label="Recipe Name *" error={errors.name}>
        <TextInput
          ...
          value={name}
          onChangeText={v => { setName(v); saveDraft('name', v); setErrors(p => ({ ...p, name: '' })); }}
      ...
      <Field label="Ingredients *" error={errors.ingredients}>
        <TextInput
          ...
          value={ingredients}
          onChangeText={v => { setIngredients(v); saveDraft('ingredients', v); setErrors(p => ({ ...p, ingredients: '' })); }}
      ...
      <Field label="Instructions *" error={errors.instructions}>
        <TextInput
          ...
          value={instructions}
          onChangeText={v => { setInstructions(v); saveDraft('instructions', v); setErrors(p => ({ ...p, instructions: '' })); }}
      ...
      <View style={styles.imageRow}>
        ...
        <TextInput
          ...
          value={imageUrl}
          onChangeText={v => { setImageUrl(v); setImageUri(''); saveDraft('imageUrl', v); }}
...
const styles = StyleSheet.create({
  ...
  saveBtn: { backgroundColor: '#E53935', borderRadius: 10, paddingVertical: 14, alignItems: 'center', marginTop: 8 },
